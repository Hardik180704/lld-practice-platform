...
export default async function HomePage() {
  ...
  return <main>
    <section className="hero shell"><div className="eyebrow"><span /> Deliberate LLD practice</div><h1>Design it. Defend it.<br /><em>Improve it.</em></h1><p className="hero-copy">Practice real low-level design problems and receive evidence-backed feedback that helps your next attempt—not just a number.</p><div className="hero-actions"><Link className="button primary" href="#problems">Choose a problem <ArrowRight size={17} /></Link><Link className="button ghost" href="/history">View attempt history</Link></div></section>
